...
namespace ERMS.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        {
            var department = await _context.Departments.FindAsync(id); // Uses FindAsync
            if (department != null) // Check if found
            {
                _context.Departments.Remove(department); // Uses DbSet<T>.Remove
            }
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
