        ...
        public async Task<ActionResult<IEnumerable<ProjectDto>>> GetProjects()
        {
             ...
             try
            {
                ...
                var projectDtos = projects.Select(p => new ProjectDto {
                    ...
                    StartDate = p.StartDate, EndDate = p.EndDate, ManagerID = p.ManagerID,
        ...
        public async Task<ActionResult<ProjectDto>> GetProject(int id)
        {
            ...
            try {
                ...
                var projectDto = new ProjectDto {
                    ...
                    StartDate = project.StartDate, EndDate = project.EndDate, ManagerID = project.ManagerID,
            ...
            // ... implementation unchanged ...
             try {
                ...
                var project = new Project {
                    ProjectName = createProjectDto.ProjectName, Description = createProjectDto.Description,
                    StartDate = createProjectDto.StartDate, EndDate = createProjectDto.EndDate,
